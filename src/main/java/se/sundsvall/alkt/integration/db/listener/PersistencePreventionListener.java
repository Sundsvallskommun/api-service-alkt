package se.sundsvall.alkt.integration.db.listener;
...
/**
 * Prevent persistence of entities by throwing exceptions on any persistence operations
 */
public class PersistencePreventionListener {
